...
<head>
    ...
    <!-- SYTLE SHEET -->
    <link rel="stylesheet" href="./css/semester_regist.css">
    ...
    <section class="homePage">
        <div class="homePage-base">
            ...
            <div class="head">
                <div class="head-1">
                    <div class="head-text">
                        <div class="pannel-heading"> Semester Registration </div>
                    </div>
                    <!-- profile -->
                    <div class="Profile">
                        <div class="pro-1">
            ...
            <!-- bread crums -->
            <div class="ss_head" style="padding:20px;">
                <div class="ss-inner-base">
                    <h4>Home / Acadmics / <span>Semester Registration</span></h4>
                </div>
            </div>
            ...
            <div class="v7_3">
                <div class="v7_4">
                    <div class="v7_5">
                        <div class="v7_6">
                            <div class="v7_6_cont">
                                <hr><br> Pending Students for Registration
                            </div>
                            <div class="v7_6_table">
                                <table>
                                    <caption>Total : <span>--value here--</span></caption>
                                    <thead>
                                        <th>S.No.</th>
                                        <th>Name</th>
                                        <th>Student ID</th>
